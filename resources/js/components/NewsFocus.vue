<template>
  <div>
      ...
      <a-table 
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <span>
              <a-space wrap>
                <a-button type="primary" @click="showDrawer(record)">詳細</a-button>
              </a-space>              
            </span>
          </template>          
        </template>
    ...
    <NewsDetail v-if="open === true" v-model:open="open" v-model:refresh="refresh" v-bind:record="selectedRecord"></NewsDetail>
  </div>
</template>
<script setup>
  ...
  watch(refresh, (newState, oldState) => {
